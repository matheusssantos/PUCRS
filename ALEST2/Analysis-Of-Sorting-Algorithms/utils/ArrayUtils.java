...
public class ArrayUtils {
  ...
  public static void imprimirComPosicao(int[] variavelArray) {
    ...
    qtdChar = qtdChar + 1;
    for (int i = 0; i < variavelArray.length; i++)
      System.out.printf("+" + "-".repeat(qtdChar + 1), i);
    System.out.printf("%n");
    for (int i = 0; i < variavelArray.length; i++) {
    ...
    System.out.printf("%n");
    for (int i = 0; i < variavelArray.length; i++)
      System.out.printf("|%" + qtdChar + "d ", i);
    System.out.printf("%n");
    for (int i = 0; i < variavelArray.length; i++)
      System.out.printf("+" + "-".repeat(qtdChar + 1), i);
  }

  public static void preencherArrayComValoresInteirosAleatorios(int[] variavelArray, int limiteSuperior,
